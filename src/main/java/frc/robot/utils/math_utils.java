...
public class math_utils {
    ...
    public static double distance(LL ll) {
        ...
        var tag_height = tag_maybe.get().getMeasureZ().in(Meters); // untested. idk if its z. i hope it is.
    ...
    public static Angle angle_between(ChassisSpeeds c1, ChassisSpeeds c2) {
        var dot = c1.vxMetersPerSecond * c2.vxMetersPerSecond + c1.vyMetersPerSecond * c2.vyMetersPerSecond;
        var cos_theta = dot / (hypot(c1) * hypot(c2));
